...
PLUGIN.author = "Spy ( http://steamcommunity.com/id/ifenerv ) Ported to NS by josephfra"
PLUGIN.desc = "Add's realistic head movement and headbob and realistic first person with legs & chest."
